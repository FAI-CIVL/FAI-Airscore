  ...
  $.ajax({
    ...
    success: function (json) {
      var columns = [
        ...
        {data: 'id', title: '', render: function ( data ) { if (editable) {
                                                              return '<button type="button" class="btn btn-primary" onclick="edit_user(' + data + ')">Edit</button>'
                                                            }
                                                            else { return '<span class="text-muted">External</span>'}
                                                          }}
      ];
