    ...
    $('#tracks').DataTable({
        ...
        columnDefs:[{
            ...
            buttons =
             ...
             +'<button id="TrackUp' + data.par_id  +'" class="btnupload btn btn-primary mt-3" onclick="choose_file(' + data.par_id +');">Upload Track</button> <input id="fileupload' + data.par_id +'" type="file" size="chars" class="custom-file-input"  oninput="filesize(this);" data-url="/users/_upload_track/'+ task_id + '/' + data.par_id + '" name="tracklog" ><div id="progress'+ data.par_id+ '"><div class="bar" style="width: 0%;"><p id="progress_text'+data.par_id +'"></p></div></div>';
             return buttons;
            }
