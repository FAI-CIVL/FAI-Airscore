...
class tblCompetition(Base):
    ...
    comDateFrom = Column(INTEGER(11), nullable=False)
    comDateTo = Column(INTEGER(11), nullable=False)
    comTimeOffset = Column(INTEGER(9), server_default=text("'0'"))
...
class tblTask(Base):
    ...
    tasDate = Column(INTEGER(11), nullable=False)
    regPk = Column(ForeignKey('tblRegion.regPk'), index=True)
    tasWindowOpen = Column(INTEGER(9))
    tasWindowClose = Column(INTEGER(9))
    tasCheckLaunch = Column(Enum('on', 'off'), server_default=text("'off'"))
    tasStartOpen = Column(INTEGER(9))
    tasStartClose = Column(INTEGER(9))
    tasSSInterval = Column(INTEGER(6), nullable=False, server_default=text("'0'"))
    tasStartIteration = Column(TINYINT)
    tasDeadline = Column(INTEGER(9))
    tasStoppedTime = Column(INTEGER(9))
    ...
    tasTimeOffset = Column(INTEGER(9))
