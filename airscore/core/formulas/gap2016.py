...
pg_preset = FormulaPreset(
    ...
    # Jump the Gun: 1 or 0
    jump_the_gun=Preset(value=False, visible=True, editable=True),
    # Max allowed Jump the Gun (seconds)
    max_JTG=Preset(value=None, visible=True, editable=True),
...
hg_preset = FormulaPreset(
    ...
    # Jump the Gun: 1 or 0
    jump_the_gun=Preset(value=1, visible=True, editable=True),
    # Max allowed Jump the Gun (seconds)
