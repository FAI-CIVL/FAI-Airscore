...
$comparr = [];
$comparr[] = array ('', fb('Date Range'), fb('Name'), fb('Class'), fb('Location'), fb('Director') );
$count = 1;
...
while($row = mysqli_fetch_assoc($result))
{
    ...
    $comparr[] = array("$count.", $datestr, "<a href=\"competition_admin.php?comPk=$id\">" . $name . "</a>", $comclass, $location, $director);
    $count++;
}
