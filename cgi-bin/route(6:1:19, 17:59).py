...
add database read and write to task object,
...
alternativley we go for the direct perl conversion (not Object Oriented) which is messier but maybe easier to get things up and running
'''
