...
if (addslashes($_REQUEST['sendmail']) == "Send Email to missing Pilots")
{
    ...
    $command = "/home/untps52y/opt/python-3.6.2/bin/python3 " . BINDIR . "email_pilots.py $tasPk reminder -t $email";
    # TEST MODE END 

	#COMMENT TO BE REMOVED IN PRODUCTION
	//$command = "/home/untps52y/opt/python-3.6.2/bin/python3 " . BINDIR . "email_pilots.py $tasPk reminder";
